package com.unmsm.chore;

import com.unmsm.services.pieces.IKingService;
import com.unmsm.services.pieces.KingService;
import com.unmsm.services.pieces.IPieceMoveService;
...
import com.unmsm.gui.ChessPanel;
import com.unmsm.gui.BoardSquare;
...
public class ChessGameEngine implements Serializable {
     ...
     */
     public boolean playerHasLegalMoves(int playerNum) {
        ...
        return pieces.stream().anyMatch(currPiece -> (pieceMoveService.hasLegalMoves(board,currPiece)));
    }
